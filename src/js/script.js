  ...
  class Product {
    ...
    processOrder() {
      ...
      for (let param in thisProduct.data.params) {
        ...
        thisProduct.data.params.param = param.element;
        //console.log('153 ', thisProduct.data.params.param);
        /* START LOOP: for each optionId in param.options */
        for (let option in param.options) {
          /* save the element in param.options with key optionId as const option */
          param.options.optionId = option.element;
          ...
          if(optionSelected){
            option.imageWrapper.classList.add(classNames.menuProduct.imageVisible);
          }
          else{
            option.imageWrapper.classList.remove(classNames.menuProduct.imageVisible);
          }
